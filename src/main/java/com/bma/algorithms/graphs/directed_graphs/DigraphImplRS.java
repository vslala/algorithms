...
public class DigraphImplRS implements Digraph {
     ...
     */
    public DigraphImplRS(DigraphImplRS G) {
     ...
     */
    public DigraphImplRS reverse() {
        DigraphImplRS reverse = new DigraphImplRS(V);
        for (int v = 0; v < V; v++) {
            for (int w : adj(v)) {
                reverse.addEdge(w, v);
            }
